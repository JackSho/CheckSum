...
"}"));
        ...
        checkBox_lower = new QCheckBox(layoutWidget);
        checkBox_lower->setObjectName(QStringLiteral("checkBox_lower"));
        checkBox_lower->setFont(font1);

        horizontalLayout_2->addWidget(checkBox_lower);
    ...
    void retranslateUi(QMainWindow *CheckSumClass)
    {
        ...
        checkBox_lower->setText(QApplication::translate("CheckSumClass", "Lower", 0));
